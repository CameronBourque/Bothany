...
/**
 * The main hub for interacting with the Discord API, and the starting point for any index.
 * @extends {BaseClient}
 */
class Client extends BaseClient {
  ...
  constructor(options = {}) {
     ...
     * as long as sharding isn't being used, this will be *every* guild the index is a member of
     * @type {GuildManager}
     */
     ...
     * as long as sharding isn't being used, this will be *every* channel in *every* guild the index
    ...
    if (!browser && !this.token && 'DISCORD_TOKEN' in process.env) {
      /**
       * Authorization token for the logged in index
  ...
  /**
   * Obtains the OAuth Application of this index from Discord.
  ...
  /**
   * Generates a link that can be used to invite the index to a guild.
   * @param {PermissionResolvable} [permissions] Permissions to request
   * @returns {Promise<string>}
   * @example
   * client.generateInvite(['SEND_MESSAGES', 'MANAGE_GUILD', 'MENTION_EVERYONE'])
   *   .then(link => console.log(`Generated index invite link: ${link}`))
   *   .catch(console.error);
   */
